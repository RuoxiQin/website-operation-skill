"""
anthropic.research.py

A utility script to fetch and parse the Anthropic Research hub (https://www.anthropic.com/research).
...
Usage:
    python3 scripts/anthropic.research.py [output_path]

If output_path is not provided, it defaults to .tmp/anthropic_research.md
"""
...
def main():
    ...
    output_path = sys.argv[1] if len(sys.argv) > 1 else ".tmp/anthropic_research.md"
